...
// MinGW-w64 download URLs and version information
// Shared between C and C++ providers

// Versions returns all available MinGW-w64 GCC versions
...
// LatestVersion returns the latest stable MinGW-w64 GCC version
func LatestVersion() string {
	return "15.2.0"
}

// DownloadURLs returns the download URL mapping for all versions and architectures
// Using .zip format for native Go support (no external 7z tool needed)
func DownloadURLs() map[string]map[string]string {
	return map[string]map[string]string{
		...
		"12.3.0": {
			"x86_64": "https://github.com/brechtsanders/winlibs_mingw/releases/download/12.3.0-16.0.4-11.0.0-ucrt-r1/winlibs-x86_64-posix-seh-gcc-12.3.0-mingw-w64ucrt-11.0.0-r1.zip",
			"i686":   "https://github.com/brechtsanders/winlibs_mingw/releases/download/12.3.0-16.0.4-11.0.0-ucrt-r1/winlibs-i686-posix-dwarf-gcc-12.3.0-mingw-w64ucrt-11.0.0-r1.zip",
		},
		"12.2.0": {
		...
		"11.2.0": {
			"x86_64": "https://github.com/brechtsanders/winlibs_mingw/releases/download/11.2.0-9.0.0-ucrt-r5/winlibs-x86_64-posix-seh-gcc-11.2.0-mingw-w64ucrt-9.0.0-r5.zip",
			"i686":   "https://github.com/brechtsanders/winlibs_mingw/releases/download/11.2.0-9.0.0-ucrt-r5/winlibs-i686-posix-dwarf-gcc-11.2.0-mingw-w64ucrt-9.0.0-r5.zip",
		},
		"11.1.0": {
...
// GetDownloadURL returns the download URL for a specific version and architecture
func GetDownloadURL(version string, arch string) (string, error) {
